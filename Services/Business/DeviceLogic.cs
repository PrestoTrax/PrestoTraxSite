...
namespace PrestoTraxSite.Services.Business
{
    public class DeviceLogic
    {
        ...
        public async void PopulateRecords(DeviceModel model)
        {
            ...
            model.IsMoving = CheckMoving(model);
        ...
        {
            double LocSum1 = double.Parse(model.Location.Latitude) + double.Parse(model.Location.Longitude);
            double LocSum2 = double.Parse(model.Records[0].Location.Latitude) + double.Parse(model.Records[0].Location.Longitude);
